#
# dsci524-group36-metrics documentation build configuration file
#
import os
import sys
...
project = "dsci524-group36-metrics"
copyright = "Copyright © 2026 Tiffany, Claudia, Bright, Charlene"
...
# built documents.
try:
    version = importlib.metadata.version("dsci524_group36_metrics")
...
htmlhelp_basename = "dsci524-group36-metrics_doc"
